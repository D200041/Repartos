...
import edu.umng.repartos.jpa.entities.Clientes;
import edu.umng.repartos.jsf.util.JsfUtil;
import edu.umng.repartos.jsf.util.JsfUtil.PersistAction;
import edu.umng.repartos.jpa.fachada.ClientesFacade;
...
public class ClientesController implements Serializable {
    ...
    @EJB
    private edu.umng.repartos.jpa.fachada.ClientesFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("ClientesCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("ClientesUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("ClientesDeleted"));
        if (!JsfUtil.isValidationFailed()) {
